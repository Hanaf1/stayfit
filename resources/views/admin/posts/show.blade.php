  ...
  <div class="container">
        <div class="row mb-5">
            <div class="col-lg-8">
                ...
                <a href="/admin/posts" class="btn btn-success"><i class="bi bi-arrow-left"></i> Back to my posts</a>
                <a href="/admin/posts/{{ $post->slug }}/edit" class="btn btn-warning"><i class="bi bi-pencil-square"></i>Edit</a>
