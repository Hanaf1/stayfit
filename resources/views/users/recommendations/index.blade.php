...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h2>Nutrisi Recommendation</h2>
    </div>

    <div class="container">
        <div class="row" id="nutritionCards">
            <div class="col-md-4 mb-4">
                <a href="recommendations/1" style="text-decoration: none; color: inherit;">
                    <div class="card">
            ...
            <div class="col-md-4 mb-4">
                <a href="recommendations/2" style="text-decoration: none; color: inherit;">
                    <div class="card">
